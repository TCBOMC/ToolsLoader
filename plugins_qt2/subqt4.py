...
'''
    ...
    def convert_otf_to_ttf(self, input_path, output_path):
        """
        使用 FontForge 将 OTF 转换为 TTF（尽量无损）

        :param input_path: 输入字体路径 (.otf)
        :param output_path: 输出字体路径 (.ttf)
        :return: 转换后的路径 or None
        """
...
"""
        ...
        # 调用你已有的方法
        success = self._run_fontforge_script(script_path)
