...
- 打包时使用以下指令打包（注意第3个add-data中脚本名称需要使用最新版主程序或指定的版本）
  ```
  pyinstaller --noconfirm --onefile --windowed --name=newUI -i icon.ico luncher9.py --add-data "icon.ico;." --add-data "python312.zip;." --add-data "uiqt0_2_3_5.py;main_script" --add-data "fonts;fonts" --add-data "resources;resources"
